...
namespace PushValidatorDemo.Controllers
{
    [Authorize]
    ...
    public class AccountController : Controller
    {
        ...
        private readonly IOptions<PushValidatorSettings> _pushValidatorSettings;

        public AccountController(
            UserManager<ApplicationUser> userManager,
            SignInManager<ApplicationUser> signInManager,
            ILogger<AccountController> logger,
            IOptions<PushValidatorSettings> pushValidatorSettings)
        {
            _userManager = userManager;
            _signInManager = signInManager;
            _logger = logger;
            _pushValidatorSettings = pushValidatorSettings;
        }
        ...
        public async Task<IActionResult> Login(LoginViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.RequiresTwoFactor)
                {
                    ...
                    return RedirectToAction(nameof(LoginWithPushValidator));
                }
        ...
        [HttpGet]
        [AllowAnonymous]
        public async Task<IActionResult> LoginWithPushValidator()
        {
